  ...
  return (
    <>
      <div className='flex justify-around'>
         <div className='card  w-[350px] ' style={{fontFamily:"sans-serif",height:"250px"}} >
            <div className='bg-blue-500 h-[50%]  w-[100%] text-2xl  text-white text-center font-bold pt-5' >
              Total Income
            </div>
            <div className='h-[30%] w-[100%]  text-center text-2xl font-bold text-gray-400 pt-5' style={{fontFamily:"monospace"}}>
              {TotalIncome}₹
            </div>
         </div>
